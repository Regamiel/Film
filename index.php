...
//Aller chercher les films correspondants grace à la fonction finder
        ...
        <div class="container">
            <div class="jumbotron">
                <h1><?php echo $title; ?></h1>
                    <p> Voici une liste de film que j'ai acheté en Blueray ou DVD et que je n'ai pas encore eu le temps de visionner.
                    Ce site n'est pas encore parfait mais nous verrons dans la fin de semaine comment l'améliorer encore.</p>
            </div>
    <?php if (count($data)>1) : ?>
